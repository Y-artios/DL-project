...
exp_name = "no_finetuning_SRGAN_x4-WORLDSAT"
...
if mode == "train":
    ...
    pretrained_d_model_weights_path = f"./pretrained_models/Discriminator_x4-ImageNet-22ca3e6c.pth.tar"
    pretrained_g_model_weights_path = f"./pretrained_models/SRGAN_x4-ImageNet-8c4a7569.pth.tar"
...
if mode == "test":
    # Test data address
    lr_dir = f"./data/Worldsat/test/lr"
    sr_dir = f"./results/test/{exp_name}"
    gt_dir = f"./data/Worldsat/test/hr"
